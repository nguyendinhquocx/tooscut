...
If you've set [in/out points](/docs/basics/markers-and-in-out-points), the dialog shows an **Export in/out range only** checkbox. Leave it unchecked to export the full timeline.
